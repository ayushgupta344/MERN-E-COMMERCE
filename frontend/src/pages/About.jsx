...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        Ayush Gupta (@ayushgupta) - Full Stack Developer & Tech Enthusiast
      </h3>
      ...
      >
        <a
          href="https://ayushgupta344-lms.vercel.app/"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://www.instagram.com/ayushh__64/"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://www.linkedin.com/in/ayushgupta344/"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://github.com/ayushgupta344"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://x.com/AyushGupta344"
          target="_blank"
          rel="noreferrer"
          style={socialBtnStyle}
        >
